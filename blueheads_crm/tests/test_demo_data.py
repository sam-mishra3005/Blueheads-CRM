...
class TestDemoData(IntegrationTestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		from blueheads_crm.demo.api import clear_demo_data
	...
	def test_demo_data_lifecycle(self):
		from blueheads_crm.demo.api import clear_demo_data, create_demo_data
		from blueheads_crm.demo.users import DEMO_USERS
		...
		avatar_dir = os.path.abspath(
			os.path.join(os.path.dirname(__file__), "..", "..", "blueheads_crm", "public", "images", "demo")
		)
		for user in DEMO_USERS:
