...
from blueheads_crm.api.exchange_rate import (
...
class TestFetchFromFrankfurter(FrappeTestCase):
	@patch("blueheads_crm.api.exchange_rate.requests.get")
	...
	@patch(
		"blueheads_crm.api.exchange_rate.requests.get",
...
class TestGetExchangeRate(FrappeTestCase):
	...
	@patch("blueheads_crm.api.exchange_rate._fetch_exchange_rate")
