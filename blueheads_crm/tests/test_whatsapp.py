...
from blueheads_crm.api.whatsapp import notify_agent, validate
...
class TestWhatsAppHooks(FrappeTestCase):
	...
	def test_validate_sets_reference_when_contact_found(self):
		...
		with patch(
			"blueheads_crm.api.whatsapp.get_contact_lead_or_deal_from_number",
	...
	def test_notify_agent_returns_early_when_no_reference(self):
		...
		with patch("blueheads_crm.api.whatsapp.get_assigned_users") as mock_users:
