...
from blueheads_crm.utils import sales_user_only
...
def get_dashboard(from_date: str | None = None, to_date: str | None = None, user: str | None = None):
	...
	for l in layout:
		...
		if hasattr(frappe.get_attr("blueheads_crm.api.dashboard"), method_name):
			method = getattr(frappe.get_attr("blueheads_crm.api.dashboard"), method_name)
