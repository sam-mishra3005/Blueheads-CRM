...
from blueheads_crm.fblueheads_crm.doctype.crm_service_level_agreement.utils import get_context
...
class CRMServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from blueheads_crm.fblueheads_crm.doctype.crm_service_day.crm_service_day import CRMServiceDay
		from blueheads_crm.fblueheads_crm.doctype.crm_service_level_priority.crm_service_level_priority import (
