...
from blueheads_crm.api.exchange_rate import get_exchange_rate
from blueheads_crm.fblueheads_crm.doctype.crm_service_level_agreement.utils import get_sla
from blueheads_crm.fblueheads_crm.doctype.crm_status_change_log.crm_status_change_log import add_status_change_log
from blueheads_crm.fblueheads_crm.doctype.utils import add_or_remove_lost_reason_section_in_sidepanel
...
class CRMDeal(Document):
	...
	if TYPE_CHECKING:
		...
		from blueheads_crm.fblueheads_crm.doctype.crm_contacts.crm_contacts import CRMContacts
		from blueheads_crm.fblueheads_crm.doctype.crm_products.crm_products import CRMProducts
		from blueheads_crm.fblueheads_crm.doctype.crm_rolling_response_time.crm_rolling_response_time import (
			CRMRollingResponseTime,
		)
		from blueheads_crm.fblueheads_crm.doctype.crm_status_change_log.crm_status_change_log import CRMStatusChangeLog
