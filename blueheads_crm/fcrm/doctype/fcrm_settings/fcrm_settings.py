...
from blueheads_crm.demo.api import create_demo_data
from blueheads_crm.install import after_install
...
class FCRMSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from blueheads_crm.fblueheads_crm.doctype.crm_dropdown_item.crm_dropdown_item import CRMDropdownItem
