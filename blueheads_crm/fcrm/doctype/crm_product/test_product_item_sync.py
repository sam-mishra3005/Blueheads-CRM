...
def enable_product_sync():
	...
	from blueheads_crm.patches.v1_0.create_custom_fields_for_product_item_sync import execute
...
class TestEchoLoopBreaker(FrappeTestCase):
	def test_payload_identical_to_target_is_noop(self):
		from blueheads_crm.fblueheads_crm.doctype.crm_product.sync_utils import payload_differs
...
class TestReconciliationRules(FrappeTestCase):
	def test_already_linked_pair_is_skipped(self):
		from blueheads_crm.fblueheads_crm.doctype.crm_product.reconciliation import classify_pair
	...
	def test_orphan_detection(self):
		from blueheads_crm.fblueheads_crm.doctype.crm_product.reconciliation import detect_orphan
...
class TestReconcileJob(FrappeTestCase):
	...
	def test_unlinked_duplicates_get_linked(self):
		from blueheads_crm.fblueheads_crm.doctype.crm_product.reconcile_job import run_reconciliation
