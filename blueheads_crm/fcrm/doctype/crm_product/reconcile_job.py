...
from blueheads_crm.fblueheads_crm.doctype.crm_product.reconciliation import (
	CATALOGUE_FIELDS,
	classify_pair,
	detect_orphan,
)
...
def enqueue_reconciliation():
	frappe.enqueue(
		"blueheads_crm.fblueheads_crm.doctype.crm_product.reconcile_job.run_reconciliation",
		queue="long",
		timeout=1200,
...
def _sync_framework_mirrors():
	from blueheads_crm.integrations.erpnext.doc_share import sync_shared_docs
	from blueheads_crm.integrations.erpnext.user_permission import sync_user_permissions
