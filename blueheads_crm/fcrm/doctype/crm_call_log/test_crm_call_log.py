...
from blueheads_crm.fblueheads_crm.doctype.crm_call_log.crm_call_log import (
...
class TestCRMCallLog(IntegrationTestCase):
	...
	def test_default_list_data_returns_actual_logs(self):
		...
		from blueheads_crm.fblueheads_crm.doctype.crm_call_log.crm_call_log import CRMCallLog
