...
def create_demo_data(_args: dict | None = None):
	...
	from blueheads_crm.demo.activities import create_demo_activities
	from blueheads_crm.demo.call_logs import create_demo_call_logs
	from blueheads_crm.demo.deals import create_demo_deals
	from blueheads_crm.demo.leads import create_demo_leads
	from blueheads_crm.demo.notes import create_demo_notes
	from blueheads_crm.demo.tasks import create_demo_tasks
	from blueheads_crm.demo.users import create_demo_users
	...
	from blueheads_crm.demo.leads import rebackdate_demo_leads
	...
	capture("demo_data_created", "blueheads_crm")
...
def clear_demo_data():
	...
	from blueheads_crm.demo.activities import delete_demo_activities
	from blueheads_crm.demo.call_logs import delete_demo_call_logs
	from blueheads_crm.demo.deals import delete_demo_deals
	from blueheads_crm.demo.leads import delete_demo_leads
	from blueheads_crm.demo.notes import delete_demo_notes
	from blueheads_crm.demo.tasks import delete_demo_tasks
	from blueheads_crm.demo.users import DEMO_USER_EMAILS, delete_demo_users
	...
	capture("demo_data_cleared", "blueheads_crm")
