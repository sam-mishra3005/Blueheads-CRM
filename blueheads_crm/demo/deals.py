...
from blueheads_crm.demo.utils import (
	backdate,
	build_full_names,
	fix_auto_records,
	insert_comment,
...
def create_demo_deals(lead_names, demo_users):
	...
	_org_logos = {
		"Acme Corp": "/assets/blueheads_crm/images/demo/acme-corp.png",
		"TechStart Inc": "/assets/blueheads_crm/images/demo/techstart-inc.png",
		"PivotTech Solutions": "/assets/blueheads_crm/images/demo/pivottech-solutions.png",
		"ScaleUp Labs": "/assets/blueheads_crm/images/demo/scaleup-labs.png",
		"Meridian Systems": "/assets/blueheads_crm/images/demo/meridian-systems.png",
		"Vertex Analytics": "/assets/blueheads_crm/images/demo/vertex-analytics.png",
		"Forge Digital": "/assets/blueheads_crm/images/demo/forge-digital.png",
	}
	now = datetime.now()
