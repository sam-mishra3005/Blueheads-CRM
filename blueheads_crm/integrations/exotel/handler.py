...
from blueheads_crm.integrations.api import get_contact_by_phone_number

# Endpoints for webhook

# Incoming Call:
# <site>/api/method/blueheads_crm.integrations.exotel.handler.handle_request?key=<exotel-webhook-verify-token>
...
def get_status_updater_url():
	...
	return get_url(f"api/method/blueheads_crm.integrations.exotel.handler.handle_request?key={webhook_verify_token}")
