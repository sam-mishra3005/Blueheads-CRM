...
class Twilio:
	...
	def get_recording_status_callback_url(self):
		url_path = "/api/method/blueheads_crm.integrations.twilio.api.update_recording_info"
		return get_public_url(url_path)

	def get_update_call_status_callback_url(self):
		url_path = "/api/method/blueheads_crm.integrations.twilio.api.update_call_status_info"
		return get_public_url(url_path)
